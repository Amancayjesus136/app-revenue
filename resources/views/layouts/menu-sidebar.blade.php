                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('ingresos.index') }}" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                            <i class="bx bx-dollar-circle"></i> <span data-key="t-dashboard">Ingresos</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('deudas.index') }}" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                            <i class="bx bx-credit-card"></i> <span data-key="t-dashboard">Deudas</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('pendientes.index') }}" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                            <i class="bx bx-list-check"></i> <span data-key="t-dashboard">Pendientes</span>
                        </a>
                    </li>
                </ul>
